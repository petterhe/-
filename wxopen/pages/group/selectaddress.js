...
Page({
  ...
  onLoad:function(options){
    ...
    if(!(options.selectAddressSysNo == undefined))
    {
      that.setData({
        selectAddressSysNo:options.selectAddressSysNo
      })
    }
  ...
  onShow: function() {
    ...
    if(app.globalData.isEditAddress)
    {
      ...
      //列表更新
      app.globalData.isEditSelectAddress = true
      getAddressList()
    }
  },
...
function selectaddress(index)
{
  selectAddressIndex = index
    ...
    app.globalData.deliveryAddressSysNo = selectAddressInfo.SysNo
    //返回
    wx.navigateBack()
}
